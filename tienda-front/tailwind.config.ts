...
const config: Config = {
  ...
  theme: {
    ...
    colors: {
      ...
      dark: {
        DEFAULT: "var(--color-dark-default, #1C274C)",
        2: "var(--color-dark-2, #495270)",
        3: "var(--color-dark-3, #606882)",
        4: "var(--color-dark-4, #8D93A5)",
      ...
      blue: {
        DEFAULT: "var(--color-blue-default, #3C50E0)",
        dark: "var(--color-blue-dark, #1C3FB7)",
        light: "var(--color-blue-light, #5475E5)",
        "light-2": "var(--color-blue-light-2, #8099EC)",
        "light-3": "var(--color-blue-light-3, #ADBCF2)",
        "light-4": "var(--color-blue-light-4, #C3CEF6)",
        "light-5": "var(--color-blue-light-5, #E1E8FF)",
      },
      red: {
        DEFAULT: "#F23030",
        dark: "#E10E0E",
