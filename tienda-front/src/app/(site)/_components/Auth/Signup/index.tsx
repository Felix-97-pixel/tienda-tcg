...
const Signup = () => {
      ...
      <>
        ...
        <section className="overflow-hidden py-20 bg-[#222630]">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="max-w-[570px] w-full mx-auto rounded-xl bg-[#1a1d24] shadow-1 p-8 sm:p-12 text-center border-t-4 border-red">
              ...
              <p className="text-gray-6 text-custom-sm leading-relaxed mb-6">
                Te hemos enviado un enlace de activación al correo electrónico: <strong className="text-white">{email}</strong>.
              </p>
              <div className="bg-red/5 border border-red/10 p-5 rounded-lg text-left text-custom-sm text-gray-7 mb-8 leading-relaxed">
                <p className="font-bold text-red mb-1.5 flex items-center gap-2">
                ...
                <ol className="list-decimal pl-4.5 space-y-1 mt-1">
                  ...
                  <li>Busca el correo de <strong className="text-white">TapTrade</strong>.</li>
  ...
  return (
    <>
      ...
      <section className="overflow-hidden py-20 bg-[#222630]">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-[#1a1d24] shadow-1 p-4 sm:p-7.5 xl:p-11">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-5">
                  ...
                  <input
                    ...
                    className="rounded-lg border border-white/10 bg-[#111318] placeholder:text-gray-5 w-full py-3 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
                  />
                </div>
