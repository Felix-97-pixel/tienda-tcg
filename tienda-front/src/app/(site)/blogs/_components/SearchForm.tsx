...
const SearchForm = () => {
  return (
    <div className="shadow-1 bg-[#1a1d24] rounded-xl">
        ...
        <form>
          <div className="relative">
            <input
              ...
              className="w-full rounded-md border border-white/10 py-3 pl-5 pr-13 outline-none ease-out duration-200 placeholder:text-gray-5 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
            />
            <button className="text-gray-2 absolute right-0 top-0 px-4 py-3.5 ease-out duration-200 hover:text-blue">
              <svg
