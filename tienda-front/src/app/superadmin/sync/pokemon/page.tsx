...
export default function PokemonSyncPage() {
  ...
  return (
    <div className="p-6 space-y-6 pb-24">
      ...
      <div className="flex flex-col xl:flex-row gap-8 max-w-6xl">
        ...
        <div className="flex-1 bg-[#0f1115] rounded-2xl shadow-xl p-6 border border-white/5 border-t-4 border-blue flex flex-col">
          <div className="flex-1">
            <h2 className="font-bold text-white mb-1">{t("pokemon.title")}</h2>
            <p className="text-xs text-gray-4 mb-4">{t("pokemon.subtitle")}</p>
          ...
          <div className="flex flex-col gap-2 mt-4">
            ...
            >
              {sync.importProgress.active ? t("inProgress") : t("pokemon.button")}
            </Button>
          </div>
        ...
        <div className="flex-1 bg-[#0f1115] rounded-2xl shadow-xl p-6 border border-white/5 border-t-4 border-blue flex flex-col">
          <div className="flex-1">
            <h2 className="font-bold text-white mb-1">{t("tcgplayer.title")}</h2>
            <p className="text-xs text-gray-4 mb-4">{t("tcgplayer.subtitle")}</p>
          ...
          >
            {sync.priceProgress.active ? t("inProgress") : t("tcgplayer.button")}
          </Button>
      ...
      {/* ESPACIO PARA FUTURAS FUNCIONES (Ej: Sincronizar Standard) */}
    </div>
  );
}
