        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <div className="relative">
              ...
              />
              {/* selectShipping === 'free' ? 'border-4 border-blue' : 'border border-white/20' */}
              <div
          ...
          >
            ...
            <div className="rounded-md border-[0.5px] py-3.5 px-5 ease-out duration-200 hover:bg-[#222630] hover:border-transparent hover:shadow-none">
