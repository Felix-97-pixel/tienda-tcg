      ...
      <div className="bg-[#1a1d24] shadow-1 rounded-[10px] p-4 sm:p-8.5">
        ...
        <div className="mb-5">
          ...
          <div className="relative">
            <select className="w-full bg-[#111318] rounded-md border border-white/10 text-gray-4 py-3 pl-5 pr-9 duration-200 appearance-none outline-none focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20">
              <option value="0">Australia</option>
              <option value="1">America</option>
              <option value="2">England</option>
            </select>

            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-4">
              <svg
          ...
          >
            <div className="relative">
              <input
                ...
                className="sr-only"
              />
              <div className="mr-2 flex h-4 w-4 items-center justify-center rounded border border-white/20">
