...
export const FileInput = React.forwardRef<HTMLInputElement, FileInputProps>(
  ({ className = "", disabled, ...props }, ref) => {
    const baseStyles = "w-full cursor-pointer rounded-xl border border-stroke bg-gray-1 py-2 px-3 text-sm text-dark-4 outline-none transition focus:border-blue transition-all disabled:opacity-50 disabled:cursor-not-allowed";
