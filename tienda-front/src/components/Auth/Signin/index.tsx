            ...
            <div>
                ...
                error.toLowerCase().includes("verific") ? (
                  <div className="mb-6 p-4 bg-yellow-100/50 border-l-4 border-yellow-500 rounded-r text-left text-custom-sm text-yellow-800 flex flex-col gap-1.5 leading-relaxed">
                    ...
                    <p className="text-xs text-gray-5 mt-1">
                      Por favor busca el enlace de activación enviado por <strong>TapTrade</strong> en tu casilla de correo o Spam.
                    </p>
                  </div>
                ) : (
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full flex justify-center items-center gap-2 font-medium text-white bg-dark py-3 px-6 rounded-lg ease-out duration-200 hover:bg-blue mt-7.5 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isLoading && (
                  ...
                  {isLoading ? "Ingresando..." : "Sign in to account"}
                </button>
