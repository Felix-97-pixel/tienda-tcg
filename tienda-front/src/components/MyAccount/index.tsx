        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex flex-col xl:flex-row gap-7.5">
              ...
              <div className="flex xl:flex-col">
                ...
                <div className="hidden lg:flex flex-wrap items-center gap-5 py-6 px-4 sm:px-7.5 xl:px-9 border-r xl:border-r-0 xl:border-b border-gray-3">
                  ...
                  <div>
                    ...
                    <p className="text-custom-xs text-dark-4">{profile?.email ?? user?.email}</p>
                  </div>
                </div>
            ...
            <div className={`xl:max-w-[770px] w-full ${activeTab === "orders" ? "block" : "hidden"}`}>
              <div className="bg-white rounded-xl shadow-1">
                <div className="py-5 px-4 sm:px-7.5 border-b border-gray-3">
                  <h3 className="font-medium text-xl text-dark">Mis pedidos</h3>
                </div>
                {loadingOrders ? (
                  ...
                  <div className="py-12 px-7.5 text-center">
                    <p className="text-dark-4 mb-4">Aún no tienes pedidos</p>
                      ...
                      return (
                        <div key={order.id} className="p-4 sm:p-6">
                          <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
                            <div>
                              <p className="font-mono text-sm text-dark font-medium">{order.buyOrder}</p>
                          ...
                          {/* Products */}
                          <div className="bg-gray-1 rounded-lg p-3 space-y-1.5">
                            {order.items.map((item) => (
                              <div key={item.id} className="flex justify-between text-sm">
                                <span className="text-dark">
                                  {item.productName} <span className="text-dark-4">× {item.quantity}</span>
                                </span>
            ...
            <div className={`xl:max-w-[770px] w-full ${activeTab === "addresses" ? "block" : "hidden"}`}>
              <div className="bg-white rounded-xl shadow-1 p-4 sm:p-8.5">
                <h3 className="font-medium text-xl text-dark mb-6">Dirección de envío</h3>
                {loadingProfile ? (
                  <p className="text-dark-4">Cargando...</p>
                ) : profile?.address || profile?.city || profile?.phone ? (
                  <div className="bg-gray-1 rounded-xl p-5 space-y-3">
                    <div className="flex items-center gap-3">
                      <svg className="w-5 h-5 text-dark-4 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-dark-4 flex-shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <div className="text-center py-8">
                    <p className="text-dark-4 mb-4">No tienes dirección guardada</p>
                    <button
                      onClick={() => setActiveTab("account-details")}
            ...
            <div className={`xl:max-w-[770px] w-full ${activeTab === "account-details" ? "block" : "hidden"}`}>
              <form onSubmit={handleSaveProfile}>
                <div className="bg-white shadow-1 rounded-xl p-4 sm:p-8.5">
                  <h3 className="font-medium text-xl text-dark mb-6">Datos de cuenta</h3>

                  <div className="mb-5">
                    <label htmlFor="profile-email" className="block mb-2.5 font-medium text-dark">
                      Correo electrónico
                    </label>
                    <input
                      type="email"
                    ...
                    />
                    <p className="text-xs text-dark-4 mt-1">El correo no se puede cambiar</p>
                  </div>

                  <div className="flex flex-col sm:flex-row gap-5 mb-5">
                    <div className="w-full">
                      <label htmlFor="profile-name" className="block mb-2.5 font-medium text-dark">
                        Nombre completo
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="w-full">
                      <label htmlFor="profile-phone" className="block mb-2.5 font-medium text-dark">
                        Teléfono
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="mb-5">
                    <label htmlFor="profile-address" className="block mb-2.5 font-medium text-dark">
                      Dirección
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="mb-6">
                    <label htmlFor="profile-city" className="block mb-2.5 font-medium text-dark">
                      Ciudad
                    </label>
                    <input
                      type="text"
